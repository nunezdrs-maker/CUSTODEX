...
export default function App() {
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    // Crear el contenido del email para mailto
    const subject = encodeURIComponent('Solicitud de contacto - CUSTODEX');
    ...
    window.location.href = `mailto:Custodexasesores@gmail.com?subject=${subject}&body=${body}`;
